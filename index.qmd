...
First, isolate class 4 and 5 pixels from our final suitability raster - this way we are only deriving energy yield estimates from our most optimal land
...
Now, use a GIS GUI (ArcGIS Pro, QGIS) to transform each raster into a polygon layer. Once done, we will filter out sites smaller than 5 acres (minimum size threshold for a 1 MW installation)
